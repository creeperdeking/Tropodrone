...
\begin{frame}{Calcul des dimensions}
  Volume ballon~:
  \begin{center}
    \boxed{\displaystyle{V = b^3 \sin \frac{\pi}{3} \times \frac{1}{3} + b^2}} \\
...
\begin{frame}{Équation de traînée}
 ...
 \begin{center}
  \boxed{\displaystyle{\frac12 \rho S Cx V^2}}
 \end{center}
 Avec : \\
 $\rho$ la masse volumique du fluide dans lequel a lieu le déplacement en $kg.m^-3$ \\
 S la surface \\
 Cx le coefficient de traînée \\
 V la vitesse relative du mobile par rapport au fluide en $m.s^-1$
\end{frame}
