...
#print("Que cherchez vous à faire? :")
#print("    1: Calculer une portance d'helium")
#print("    2: Avoir les estimations detaillées des couts du drone")
...
def permeabilite():
	#La permeabilité du gaz est en cc/100in^2/24h/atm/mil
	#intéressant: il est dit que le mylar peut être encore plus imperméable (permeabilité multipliée par 100 si, je cite: (up to a factor of 100) can be obtained through polymeric coatings, metal foil laminations, or
